...
return {
  -- add a few keybindings
  {
    ...
    opts = function(_, opts)
      ...
      if opt then opt.cmdheight = 1 end

      local maps = assert(opts.mappings)

      -- quick save
      maps.n["<C-S>"] = function() require("vscode").action "workbench.action.files.save" end
      ...
      -- terminal
      -- maps.n["<Leader>t"] = function() require("vscode").action "workbench.action.terminal.toggleTerminal" end
      maps.n["<Leader>t"] = function() require("vscode").action "workbench.action.togglePanel" end
      maps.n["<Leader>T"] = function() require("vscode").action "workbench.action.terminal.toggleTerminal" end
      ...
      -- file explorer
      maps.n["<Leader>e"] = function() require("vscode").action "workbench.action.toggleSidebarVisibility" end
